...
it('can replace a path in a json response', function (): void {
...
it('can replace a path and the text in a json response', function (): void {
    $response = mock_fixture('json')
...
it('can replace the text in a string response', function (): void {
...
it('can only replace text in a string response', function (): void {
    $response = mock_fixture('html')
